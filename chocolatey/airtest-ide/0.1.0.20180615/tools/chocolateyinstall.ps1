...
$packageArgs = @{
  ...
  url           = 'https://top.gdl.netease.com/AirtestIDE_2018-06-15_py3_win32.zip' # download url, HTTPS preferred
  url64bit      = 'https://top.gdl.netease.com/AirtestIDE_2018-06-15_py3_win64.zip' # 64bit URL here (HTTPS preferred) or remove - if installer contains both (very rare), use $url
  #file         = $fileLocation
  #fileFullPath = $fileLocation
  #destination   = Join-Path $toolsDir $folderName

  checksum      = '2542F41E07E53984BCD6BC219415038B1BA1857076945806891BD0CB6A592A5A'
  checksumType  = 'sha256' #default is md5, can also be sha1, sha256 or sha512

  checksum64    = '9F7474F358B602DEC97C19B4A6971AB1282602EC7157F679B58CC894043AE113'
