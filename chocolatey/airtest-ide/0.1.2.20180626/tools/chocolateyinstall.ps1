...
$packageArgs = @{
  ...
  url           = 'https://top.gdl.netease.com/AirtestIDE_2018-06-26_py3_win32.zip' # download url, HTTPS preferred
  url64bit      = 'https://top.gdl.netease.com/AirtestIDE_2018-06-26_py3_win64.zip' # 64bit URL here (HTTPS preferred) or remove - if installer contains both (very rare), use $url
  #file         = $fileLocation
  #fileFullPath = $fileLocation
  #destination   = Join-Path $toolsDir $folderName

  checksum      = '8C66A14252CFF7D35DEDE96EFDFA085431C39760AE21FEE23C394BFCB4E232AA'
  checksumType  = 'sha256' #default is md5, can also be sha1, sha256 or sha512

  checksum64    = '45C10D74E7C3C593AF398AF2DAC7263088AFDD08F5F968E9964F3A0F9575BD4E'
