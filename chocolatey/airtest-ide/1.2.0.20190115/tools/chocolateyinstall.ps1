...
$packageArgs = @{
  ...
  url           = 'https://top.gdl.netease.com/AirtestIDE_2019-01-15_py3_win32.zip' # download url, HTTPS preferred
  url64bit      = 'https://top.gdl.netease.com/AirtestIDE_2019-01-15_py3_win64.zip' # 64bit URL here (HTTPS preferred) or remove - if installer contains both (very rare), use $url
  #file         = $fileLocation
  #fileFullPath = $fileLocation
  #destination   = Join-Path $toolsDir $folderName

  checksum      = '3B98D76DEDEF0939F53A636AAC559DBE275B82F18FD84CDFBFA47BC62DEBC743'
  checksumType  = 'sha256' #default is md5, can also be sha1, sha256 or sha512

  checksum64    = '18256C76A0FB39E0229ED3470E21AFC90AAEE2F5EF102EF6C67C6BF8A1BB9CBD'
