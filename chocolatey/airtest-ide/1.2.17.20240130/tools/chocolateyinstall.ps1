...
$packageArgs = @{
  ...
  url           = 'https://airtestproject.s3.netease.com/downloads/AirtestIDE/win64/AirtestIDE-win-1.2.17.zip' # download url, HTTPS preferred
  #file         = $fileLocation
  #fileFullPath = $fileLocation
  #destination   = Join-Path $toolsDir $folderName

  checksum      = 'CF750D0112A165DB8D7BEC4A4647A86B8CD1660305E740685553D03AD0092F95'
