...
$packageArgs = @{
  ...
  url           = 'https://airtestproject.s3.netease.com/downloads/AirtestIDE/win64/AirtestIDE-win32-win-1.2.4.zip' # download url, HTTPS preferred
  url64bit      = 'https://airtestproject.s3.netease.com/downloads/AirtestIDE/win32/AirtestIDE-win64-win-1.2.4.zip' # 64bit URL here (HTTPS preferred) or remove - if installer contains both (very rare), use $url
  #file         = $fileLocation
