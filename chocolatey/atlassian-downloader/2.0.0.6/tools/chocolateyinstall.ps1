...
$packageArgs = @{
  ...
  url           = 'https://github.com/EpicMorg/atlassian-downloader/releases/download/2.0.0.6/atlassian-downloader-net9.0-win-x86.zip' # download url, HTTPS preferred
  url64bit      = 'https://github.com/EpicMorg/atlassian-downloader/releases/download/2.0.0.6/atlassian-downloader-net9.0-win-x64.zip' # 64bit URL here (HTTPS preferred) or remove - if installer contains both (very rare), use $url
  #file         = $fileLocation
  #fileFullPath = $fileLocation
  #destination   = Join-Path $toolsDir $folderName

  checksum      = '579271e0fbb3025eeb8b911903aea296d149c2bf163f28a6f9f2e6c68ad9484e'
  checksumType  = 'sha256' #default is md5, can also be sha1, sha256 or sha512

  checksum64    = 'e27f45f38ce321ff32c85b0b50dd74e4f160c983d1e03e5a88f00997dca67e0c'
