...
$packageArgs = @{
  ...
  url           = 'https://github.com/EpicMorg/atlassian-downloader/releases/download/2.0.0.7/atlassian-downloader-net10.0-win-x86.zip' # download url, HTTPS preferred
  url64bit      = 'https://github.com/EpicMorg/atlassian-downloader/releases/download/2.0.0.7/atlassian-downloader-net10.0-win-x64.zip' # 64bit URL here (HTTPS preferred) or remove - if installer contains both (very rare), use $url
  #file         = $fileLocation
