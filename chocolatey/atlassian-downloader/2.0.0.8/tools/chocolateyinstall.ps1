...
$packageArgs = @{
  ...
  url           = 'https://github.com/EpicMorg/atlassian-downloader/releases/download/2.0.0.8/atlassian-downloader-dotnet10.0-win-x86.zip' # download url, HTTPS preferred
  url64bit      = 'https://github.com/EpicMorg/atlassian-downloader/releases/download/2.0.0.8/atlassian-downloader-dotnet10.0-win-x64.zip' # 64bit URL here (HTTPS preferred) or remove - if installer contains both (very rare), use $url
  #file         = $fileLocation
  #fileFullPath = $fileLocation
  #destination   = Join-Path $toolsDir $folderName

  checksum      = '25335b1bb901611c0209dac5d6f53e3e185586eb52f27797124e527e91a70f7e'
  checksumType  = 'sha256' #default is md5, can also be sha1, sha256 or sha512

  checksum64    = 'd0e2a920f47e35c08f3f6199058b72843d2ce9a636238addad891ff84e73c0b6'
